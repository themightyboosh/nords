...
* **Pivoting:** The user can swap axes, or select a completely different Line Type onto either slot at any time. The Reveal plays — Nards animate from one grid configuration to another. This creates an infinitely recomposable dashboard.
...
* **Dock Tools:** Columns ▾ (Line Type selector), Rows (optional Line Type), Sticky, + New ▾.
