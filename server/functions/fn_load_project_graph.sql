-- ═══════════════════════════════════════════════════════════
-- fn_load_project_graph
-- ═══════════════════════════════════════════════════════════
-- Loads the entire project graph in one round trip.
-- Returns all nord_types, nords, connection_types, connections,
-- and board_positions as a single JSON payload.
--
-- History: 004 → 007 → 008 → 034 (current)
